...
//  AngryBirdClone
//
//  Created by Süleyman Yalçınkaya on 10.09.2022.
//
...
class GameScene: SKScene, SKPhysicsContactDelegate {
   ...
   //var bird2 = SKSpriteNode()
    ...
    override func didMove(to view: SKView) {
        ...
        bird2.position = CGPoint(x: -self.frame.width / 4 , y: -self.frame.height / 5)
    ...
    override func update(_ currentTime: TimeInterval) {
        ...
        if let birdPhysicBody = bird.physicsBody{
            ...
            if birdPhysicBody.velocity.dx <= 0.1 && birdPhysicBody.velocity.dy <= 0.1 &&
                birdPhysicBody.angularVelocity <= 0.1 && gameStarted == true {
